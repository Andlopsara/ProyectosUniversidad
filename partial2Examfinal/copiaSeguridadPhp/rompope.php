...
<head>
    ...
    <link rel="stylesheet" href="styleRompope.css">
    <title>Rompope</title>
    <style>
        body {
    margin: 0;
            ...
            <div class="cubos-container">
                <div class="cubosrojosder">
                    <div class="text-container">
                        <p class="p-style1">Rompope tradicional<br>Esmeralda 500 ml</p>
                        <h4 class="h4-style">$60.00 MXN</h4>
                    </div>
                    <img src="https://superlavioleta.com/cdn/shop/products/IMG_5813.png?v=1609624615"
        ...
        <div class="cubos-container1">
            <div class="cubosrojosder1">
                <div class="text-container1">
                    <p class="p-style1">Rompope tradicional<br>Esmeralda 1 L</p>
                    <h4 class="h4-style1">$120.00 MXN</h4>
                </div>
                <img src="https://balu.com.mx/wp-content/uploads/2024/02/Rompope-Esmeralda-1-Litro-2.webp"
                     class="img" alt="Salsa habanera">
            </div>
            <div class="cuadroApply">Agregar al carrito</div>
    </div>
