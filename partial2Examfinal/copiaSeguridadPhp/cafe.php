            ...
            <div class="cubos-container">
                <div class="cubosrojosder">
                    <div class="text-container">
                        <p class="p-style">Charola Capuchino <br> 8oz (20vasos) </p>
                        <h4 class="h4-style">$146.00 MXN</h4>
                    </div>
                    <img src="https://www.salsasdonvasco.com/cdn/shop/products/Capuchino.001_1024x1024@2x.jpg?v=1651525731"
        ...
        <div class="cubos-container1">
            <div class="cubosrojosder1">
                <div class="text-container1">
                    <p class="p-style1">Display café negro soluble <br>(24 sobres de 12 g c/u)</p>
                    <h4 class="h4-style1">$123.00 MXN</h4>
                </div>
                <img src="https://www.salsasdonvasco.com/cdn/shop/products/Productosdetienda-12_1024x1024@2x.png?v=1644362610"
                     class="img" alt="Salsa habanera">
            </div>
            <div class="cuadroApply">Agregar al carrito</div>
    </div>
