...
<head>
    ...
    <link rel="stylesheet" href="styleSalsas.css">
    <title>Salsas</title>
    <style>
       body {
    margin: 0;
            ...
            <div class="cubos-container">
                <div class="cubosrojosder">
                    <div class="text-container">
                        <p class="p-style">Salsa habanera <br>Don Vasco de 355 mg</p>
                        <h4 class="h4-style">$29.00 MXN</h4>
                    </div>
                    <img src="https://www.salsasdonvasco.com/cdn/shop/products/385grVidHabanero_1024x1024@2x.png?v=1651613185"
        ...
        <div class="cubos-container1">
            <div class="cubosrojosder1">
                <div class="text-container1">
                    <p class="p-style1">Salsa habanera <br>Don Vasco de 215 mg</p>
                    <h4 class="h4-style1">$25.00 MXN</h4>
                </div>
                <img src="https://www.salsasdonvasco.com/cdn/shop/products/Productosdetienda-09_1024x1024@2x.png"
                     class="img" alt="Salsa habanera">
            </div>
            <div class="cuadroApply">Agregar al carrito</div>
    </div>
